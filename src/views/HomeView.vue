  ...
  <section id="banner"
    ...
    <div id="banner-left" class="grid gap-5 max-w-xl text-center lg:text-left">
      ...
      <p class="text-base text-[#4D4C4C]">
        ...
        des Lettres. His books have been translated into over 40 languages.
      </p>
      <button class="w-full sm:w-[240px] sm:mx-auto lg:mx-0 bg-[#27AE60] p-2 text-base text-white rounded">
