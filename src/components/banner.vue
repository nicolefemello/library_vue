  ...
  <div class="relative overflow-hidden w-full h-full">
    ...
    >
      ...
      >
        <div
          id="banner-left"
          class="grid gap-5 max-w-xl text-center lg:text-left"
        >
          <p
            class="p-2 w-fit mx-auto lg:mx-0 text-sm text-[#27AE60] border border-[#27AE60]"
          >
            Autor de Abril
          </p>
          <h2
            class="font-bold text-3xl md:text-5xl text-[#382C2C] line-clamp-3"
          >
            {{ book.volumeInfo.title }}
          </h2>
          <p class="text-base text-[#4D4C4C] line-clamp-5">
    ...
    >
      <button
        ...
        :class="currentIndex === index ? 'bg-[#27AE60]' : 'bg-gray-300'"
